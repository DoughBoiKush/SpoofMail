...
<body>
	<div id="container">
		<h1>Sending emails with attachments - <a href="https://github.com/Rumpelstiltsquin">SpoofMail</a></h1>
		<?php
			//si se ha enviado el correo
			if(isset($_REQUEST['s'])){
				$ok = $_REQUEST['s'];
				if($ok == 'si'){
				echo "<div class='msn-ok'>Done !  ;) </div>";
				}
				elseif($ok == 'no'){
					echo "<div class='msn-ko'>Not send  :( </div>";
				}
			}
		?>
